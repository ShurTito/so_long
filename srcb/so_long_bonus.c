...
/*   Updated: 2023/07/14 14:34:17 by antferna         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	init_imgs2(t_game *game)
{
	game->text_mob1 = mlx_load_png("./images/enemy1.png");
	game->text_mob2 = mlx_load_png("./images/enemy2.png");
	game->img_mob1 = mlx_texture_to_image(game->mlx, game->text_mob1);
